...
NODES+=("https://github.com/kijai/ComfyUI-KJNodes")
NODES+=("https://github.com/cubiq/ComfyUI_essentials")
NODES+=("https://github.com/chrisgoringe/cg-use-everywhere")
NODES+=("https://github.com/lquesada/ComfyUI-Inpaint-CropAndStitch")
NODES+=("https://github.com/city96/ComfyUI-GGUF")